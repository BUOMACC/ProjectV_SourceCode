...
<img src="https://github.com/BUOMACC/ProjectV_SourceCode/blob/main/Images/Input_01.png" width="100%" height="100%"/>
<img src="https://github.com/BUOMACC/ProjectV_SourceCode/blob/main/Images/Input_02.png" width="100%" height="100%"/>
</details>
...
<a name="input_02"></a>
### 2.2 선입력 처리
행동을 하는 도중 키를 눌러 놓으면 원하는 시점에 다음 동적으로 연계되는 기능을 구현했습니다.
- 마지막으로 누른 입력이 기록됩니다.
- 기록된 입력은 원하는 시점에 소모하여 다음 동작으로 연결할 수 있습니다.

<details>
<summary> 이미지 접기 / 펼치기 </summary>
<img src="https://github.com/BUOMACC/ProjectV_SourceCode/blob/main/Images/Input_03.png" width="100%" height="100%"/>
<img src="https://github.com/BUOMACC/ProjectV_SourceCode/blob/main/Images/Input_04.png" width="100%" height="100%"/>
</details>

AnimNotifyState를 활용한 선입력 처리는 아래와 같은 조건을 고려하여 결정했습니다.
...
원하는 용도로 사용할 수 있게 만들어진 FLAG_Custom을 활용해서 동기화된 Flag는 bWantsToRootMotionRotation 변수에 저장하여 회전을 사용하고자 할때 설정해주었습니다.
