...
#include "DeathBlowExecutorAbility_Back.h"
#include "FunctionLibrary/CommonFunctionLibrary.h"
#include "ProjectVLogs.h"

bool UDeathBlowExecutorAbility_Back::CanActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayTagContainer* SourceTags, const FGameplayTagContainer* TargetTags, OUT FGameplayTagContainer* OptionalRelevantTags) const
{
